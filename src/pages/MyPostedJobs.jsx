    ...
    const modernDelete = id => {
        toast(t => (
            <div className="flex gap-3 items-center">
                ...
                <div>
                    <button
                        className="bg-rose-600 text-white px-3 py-2 rounded-md mr-2"
                        onClick={() => {
                            toast.dismiss(t.id);
                            handleDelete(id);
                        }}>
                    ...
                    <button className="bg-green-500 text-white px-3 py-2 rounded-md" onClick={() => toast.dismiss(t.id)}>
                        Cancel
                    </button>
                </div>
            </div>
    ...
    return (
        <section className="container px-4 mx-auto pt-12">
            <div className="flex items-center gap-x-3">
                ...
                <span className="px-3 py-1 text-xs text-blue-600 bg-blue-100 rounded-full ">{jobs.length} Job</span>
            </div>
                        ...
                        <div className="overflow-hidden border border-gray-200  md:rounded-lg">
                            <table className="min-w-full divide-y divide-gray-200">
                                ...
                                <tbody className="bg-white divide-y divide-gray-200 ">
                                    ...
                                    {jobs.map(job => (
                                        <tr key={job._id}>
                                            <td className="px-4 py-4 text-sm text-gray-500  whitespace-nowrap">{job.title}</td>

                                            <td className="px-4 py-4 text-sm text-gray-500  whitespace-nowrap">{format(new Date(job.deadline), 'P')}</td>
                                            ...
                                            <td className="px-4 py-4 text-sm text-gray-500  whitespace-nowrap">{job.description.substring(0, 20)}...</td>
