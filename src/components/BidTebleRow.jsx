...
const BidTebleRow = ({ bid }) => {
    ...
    return (
        <tr>
            ...
            <td className="px-4 py-4 text-sm text-gray-500  whitespace-nowrap">{format(new Date(deadline), 'P')}</td>

            <td className="px-4 py-4 text-sm text-gray-500  whitespace-nowrap">${price}</td>
            <td className="px-4 py-4 text-sm whitespace-nowrap">
                <div className="flex items-center gap-x-2">
                    <p
                        className={`px-3 py-1  ${category === 'Web Development' && 'text-blue-500 bg-blue-100/60'}  ${category === 'Graphics Design' && 'text-green-500 bg-green-100/60'}  ${
